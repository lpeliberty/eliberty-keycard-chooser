...
exports.isSwissPassPropertyValid = isSwissPassPropertyValid;
...
function isSwissPassPropertyValid(localItemInfo, property) {
  return getCardNumberTypeElement(localItemInfo, 'swisspass').get(property, false);
}
/**
