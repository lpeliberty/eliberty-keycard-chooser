...
var CardNumberField = function (_React$Component) {
  ...
  _createClass(CardNumberField, [{
    ...
    value: function onSuggestionsFetchRequested(_ref) {
      ...
      var listKeycards = AutoSuggestionHelper.getSuggestions(value, this.props.keycards.toJS(), this.props.params);
    ...
    value: function onSuggestionSelected(event, _ref2) {
      ...
      var cardnumber = suggestion.mode === tabKeycardType['open'] ? suggestion.shortnumber : suggestion.cardnumber;
