...
var KeyCard = function (_React$Component) {
  ...
  _createClass(KeyCard, [{
    ...
    value: function handleChangeZipcode(event) {
      ...
      if (!isValid) {
        var _formatMessage = this.props.intl.formatMessage;

        var errorLabel = _formatMessage({ id: 'rp.checkout.customize.swisspass.zipcode.invalid', defaultMessage: 'invalid' });
