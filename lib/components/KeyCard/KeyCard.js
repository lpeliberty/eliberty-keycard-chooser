  ...
  _createClass(KeyCard, [{
      ...
      if (cardnumber !== undefined && typeof cardnumber !== 'undefined') {
        ...
        if (cardnumber !== '' || cardnumber !== undefined) {
          ...
          if (validKeycard) {
            ...
            } else if ((0, _CardTypeHelper.canCheckSwissPass)(this.props.localItemInfo)) {
    ...
    value: function renderedKeyCardTypesContent(keycardTypes) {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          keycardTypes.map(function (type) {
    ...
    value: function renderedInputOneKeyCard(type) {
      ...
      */
      return _react2.default.createElement(
        ...
        cardNumber === '' || (0, _CardTypeHelper.isCurrentCardNumberValid)(this.props.localItemInfo) === false ? KeyCard.renderedErrorInputMessage(errorKey, this.props.localItemInfo) : ''
      );
    }
    ...
    value: function renderedSomeInputKeyCards(type) {
      ...
      return _react2.default.createElement(
        ...
        this.renderedCardNumberField(type, cardNumber),
        this.state.checkYes ? this.renderedLabelLinkPopover() : '',
        cardNumber === '' || isCurrentType === false ? KeyCard.renderedErrorInputMessage(errorKey, this.props.localItemInfo) : '',
