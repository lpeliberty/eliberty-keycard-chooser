...
var KeyCard = function (_React$Component) {
  ...
  _createClass(KeyCard, [{
    ...
    value: function handleChangeCheckSwisspass(skierIndex) {
    ...
    value: function renderedLabelTab(textType, type) {
      ...
      var labelKeycard = 'rp.checkout.keycard.label.' + type;
    ...
    value: function renderedContentForSwisspass() {
      ...
      var mask = _extends({}, configs['ZIPCODE']);
      var formatMessage = this.props.intl.formatMessage;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactTextMask2.default, _extends({}, mask, {
            name: 'zipcode-swiss',
            id: 'zipcode-swiss',
            'data-control': 'true',
            onChange: function onChange(event) {
          ...
          _react2.default.createElement(
            'label',
            { htmlFor: 'zipcode-swiss', className: 'control-label' },
        ...
        _react2.default.createElement('input', {
          ...
          , onClick: function onClick() {
            return _this6.handleChangeCheckSwisspass(_this6.props.localItemInfo.get('skierIndex'));
          }
        }),
        ' ',
        ...
        _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: formatMessage({ id: 'rp.checkout.keycard.swisspass.link', defaultMessage: 'Disclaimer' }) } })
      );
    }
  }, {
    key: 'render',
