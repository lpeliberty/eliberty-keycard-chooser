...
var CardTypeHelper = _interopRequireWildcard(_CardTypeHelper);
...
var KeyCard = function (_React$Component) {
  ...
  _createClass(KeyCard, null, [{
    ...
    key: 'verifyZipcode',
    value: function verifyZipcode(zipcode) {
      var patternZipcode = /^[0-9]{4}$/;
  ...
  _createClass(KeyCard, [{
    ...
    value: function handleChangeCheckSwisspass() {
      ...
      var currentItem = this.props.localItemInfo.get('keycardsMask', new _immutable.Map());
      var newValue = !currentItem.get('swisspassElem', new _immutable.Map()).get('checked');
    ...
    value: function handleChangeZipcode(event) {
      var currentId = this.props.localItemInfo.get('skierIndex');
      var value = this.props.localItemInfo.get('keycardsMask').get('swisspassElem').get('zipcode');
      var newValue = KeyCard.verifyZipcode(value);
        ...
        if (cardnumber !== '' || cardnumber !== undefined) {
          ...
          if (validKeycard) {
            ...
            if (cardType !== tabKeycardType.swisspass) {
              ...
              var zipCode = CardTypeHelper.getSwissPassProperty('zipcode');
    ...
    value: function renderedLabelTab(type, index) {
      ...
      var aux = 'type' + index;
      var className = 'nav-item disabled';
    ...
    value: function renderedContentForSwisspass() {
      ...
      return this.props.localItemInfo.get('keycardsMask').get('current') === "swisspass" ? _react2.default.createElement(
        'div',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'blockPopover test', key: id },
        _react2.default.createElement(
          'div',
...
KeyCard.propTypes = {
  ...
  updateSwissPassElem: _propTypes.PropTypes.func.isRequired,
