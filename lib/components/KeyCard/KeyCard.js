      ...
      if (cardnumber !== undefined && typeof cardnumber !== 'undefined') {
        ...
        this.props.localItemInfo.get('keycardsMask').forEach(function (item, key) {
          if (key !== 'current' && key !== 'idCard' && key !== type && key !== 'swisspassElem') {
            ...
            _this2.props.updateKeycardsMask(skierIndex, key, newValue);
          }
        });
        ...
        var isSwissPass = cardType === tabKeycardType.swisspass;
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                fields.get('keycard').get('hasSupport', false) === true ? _react2.default.createElement(_reactToggleSwitch2.default, {
                  on: !hasSupport,
                  onClick: function onClick() {
