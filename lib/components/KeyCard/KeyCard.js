...
var KeyCard = function (_React$Component) {
  ...
  _createClass(KeyCard, [{
    ...
    value: function renderedContentForSwisspass() {
      console.log(this.props.localItemInfo.get('keycardsMask').get('current'));
      return this.props.localItemInfo.get('keycardsMask').get('current').toUpperCase() === tabKeycardType.swisspass ? _react2.default.createElement(
        'div',
        { className: 'contentSwisspass' },
        _react2.default.createElement('input', { type: 'text', name: 'zipcodeSwiss', id: 'zipcodeSwiss', className: 'form-control', placeholder: 'Code Postal', style: '', 'data-control': 'true', onKeyUp: '$(this).attr(\'value\', $(this).val())', value: '' }),
        _react2.default.createElement(
          'label',
          { htmlFor: 'zipcode' },
          'Je suis d\'accord avec les conditions du SwissPass'
        ),
        _react2.default.createElement('input', { type: 'checkbox', value: '1', name: 'checkSwisspass', id: 'checkSwisspass' }),
        _react2.default.createElement(
          'label',
          { htmlFor: 'checkSwisspass' },
          'Je suis d\'accord avec les conditions du SwissPass'
        )
      ) : null;
    }
