          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              itemFieldsDefinition.get('keycard').get('forceReloading') === false ? _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { type: 'radio', id: 'inputCheckYes' + this.props.orderitem.get('skierIndex'), name: 'card', checked: checkSupportYes, value: 'yes', onChange: function onChange() {
                    _this6.handleClickCheckYes();
                  } }),
                _react2.default.createElement(
                  'label',
                  { htmlFor: 'inputCheckYes' + this.props.orderitem.get('skierIndex'), className: 'keycardChoice' },
                  _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'rp.checkout.keycard.area.reponse.yes', defaultMessage: 'yes' })
                ),
                _react2.default.createElement('input', { type: 'radio', id: 'inputCheckNo' + this.props.orderitem.get('skierIndex'), name: 'card', value: 'non', checked: checkSupportNo, onChange: function onChange() {
                    _this6.handleClickCheckNo();
                  } }),
                _react2.default.createElement(
                  'label',
                  { htmlFor: 'inputCheckNo' + this.props.orderitem.get('skierIndex'), className: 'keycardChoice' },
