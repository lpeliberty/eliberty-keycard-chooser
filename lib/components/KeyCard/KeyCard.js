  ...
  _createClass(KeyCard, [{
    ...
    value: function renderedContentForSwisspass() {
      return this.props.localItemInfo.get('keycardsMask').get('current') === "swisspass" ? _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', name: 'zipcode-swiss', id: 'zipcode-swiss', className: 'form-control', maxLength: '4', 'data-control': 'true' }),
        _react2.default.createElement(
          'label',
        ...
        _react2.default.createElement('input', { type: 'checkbox', value: '1', name: 'check-swisspass', id: 'check-swisspass' }),
        _react2.default.createElement(
          'label',
