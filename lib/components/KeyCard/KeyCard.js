...
var KeyCard = function (_React$Component) {
  ...
  _createClass(KeyCard, [{
    ...
    key: 'validateSwissPass',
    value: function validateSwissPass(localItemInfo) {
      console.log('validateSwissPass', localItemInfo.toJS());
      if ((0, _CardTypeHelper.canCheckSwissPass)(this.props.localItemInfo)) {
    ...
    value: function renderedContentForSwisspass() {
      ...
      return _react2.default.createElement(
        ...
        !(0, _CardTypeHelper.isSwissPassZipCodeValid)(this.props.localItemInfo) ? KeyCard.renderedErrorInputMessage('data.swisspass.zipcode', this.props.localItemInfo) : '',
        _react2.default.createElement('input', {
          type: 'checkbox'
