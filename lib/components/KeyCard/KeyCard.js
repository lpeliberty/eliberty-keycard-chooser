  ...
  _createClass(KeyCard, [{
    ...
    value: function renderedListKeyCard(keycardTypes) {
      ...
      _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('ul', { className: 'nav nav-tabs nav-justified responsive-tabs', role: 'tablist' }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'blockPopover test', key: key },
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              itemFieldsDefinition.get('keycard').get('forceReloading') === false ? _react2.default.createElement(_reactToggleSwitch2.default, {
                on: !hasSupport,
                onClick: function onClick() {
                  _this5.handleChangeToggle(hasSupport);
                }
              }) : ''
            )
          ),
...
KeyCard.propTypes = {
  key: _propTypes.PropTypes.string.isRequired, // index
