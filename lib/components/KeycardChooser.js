...
var _actions = require('../../../../app/redux/actions/actions');
...
KeycardChooser.propTypes = {
  ...
  popover: _propTypes2.default.object.isRequired,
  hasSupport: _propTypes2.default.bool.isRequired,
  localItemInfo: _propTypes2.default.object.isRequired,
  ...
  setTypeCard: _propTypes2.default.func.isRequired // function to set type card on a item (orderitem)
};
