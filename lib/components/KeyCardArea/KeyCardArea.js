      ...
      return keycardTypes.size > 1 ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          keycardTypes.map(function (card, index) {
            return _this3.renderedLabelTab(tabKeycardType[card], index);
          })
        ),
        _react2.default.createElement(
          'div',
          ...
          keycardTypes.map(function (card, index) {
            return _this3.renderedSomeInputKeyCards(card, index, keycards, params);
          })
        )
      ) : keycardTypes.map(function (card, index) {
        return _this3.renderedOneInputKeyCard(card, index, keycards, params);
      });
    }
        ...
        _react2.default.createElement(
          'a',
          {
            ...
            onClick: function onClick() {
              _this6.props.updateKeycardsMask(_this6.props.localItemInfo.get('id'), 'idCard', index);
            }
          },
          card
        )
