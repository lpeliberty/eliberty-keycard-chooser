...
var KeyCardArea = function (_React$Component) {
  ...
  _createClass(KeyCardArea, [{
    ...
    value: function verifyLengthKeycard(cardNumberList, index, card) {
      var reg = new RegExp(/( )|(_)/g);
      var cardNumber = cardNumberList.get(index).replace(reg, '');
    ...
    value: function renderedListKeyCard(keycardTypes, cardNumberList, keycards, params) {
      ...
      return keycardTypes.size > 1 ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          keycardTypes.map(function (card, index) {
            return _this5.renderedSomeInputKeyCards(card, index, cardNumberList, keycards, params);
          })
        )
      ) : keycardTypes.map(function (card, index) {
        return _this5.renderedOneInputKeyCard(card, index, cardNumberList, keycards, params);
      });
    }
    ...
    value: function renderedLabelLinkPopover() {
      return this.props.popoverLink.get('labelKeycardInfo') !== null ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactstrap.Popover,
          { placement: 'bottom', isOpen: this.state.popover2Open, target: 'PopoverLink', toggle: this.changeStatePopoverLinkOpen, className: 'ppPopover' },
          _react2.default.createElement(
    ...
    value: function render() {
      ...
      var _state = this.state,
          cardNumberList = _state.cardNumberList,
          hasSupport = _state.hasSupport;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactstrap.Popover,
              { placement: 'bottom', isOpen: this.state.popoverOpen, target: 'Popover1', toggle: this.changeStatePopoverOpen, className: 'ppPopover' },
              _react2.default.createElement(
                _reactstrap.PopoverHeader,
                { className: 'popover-title ppHeader' },
...
KeyCardArea.propTypes = {
  ...
  setTypeCard: _propTypes.PropTypes.func.isRequired // function to set type card on a item (orderitem)
};
