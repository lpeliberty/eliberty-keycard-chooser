    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { href: '#', className: 'infoKeyCard', id: 'PopoverLink' + index, onClick: this.changeStatePopoverLinkOpen },
          _react2.default.createElement(
            'span',
            null,
        ...
        _react2.default.createElement(
          _reactstrap.Popover,
          { placement: 'bottom', isOpen: this.state.popoverLinkOpen, target: 'PopoverLink' + index, toggle: this.changeStatePopoverLinkOpen, className: 'ppPopover' },
          _react2.default.createElement(
