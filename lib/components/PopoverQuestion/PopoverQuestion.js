...
function (_React$Component) {
  ...
  function PopoverQuestion(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PopoverQuestion).call(this, props));
    _this.state = {
  ...
  _createClass(PopoverQuestion, [{
    ...
    value: function render() {
      ...
      }, PopoverQuestion.questionImageSvg()), _react["default"].createElement(_reactstrap.Popover, {
        placement: "bottom",
      ...
      }, popover.get('keycardTitle')), _react["default"].createElement(_reactstrap.PopoverBody, {
